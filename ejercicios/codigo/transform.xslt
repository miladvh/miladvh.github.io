        ...
        <xsl:element name="html">
            ...
            <body>
                <header class="site-header">
                    <div class="wrapper">
                        <a class="site-title" rel="author" href="/">MILA DVH</a>
                        <nav class="site-nav">
                    ...
                    <div class="wrapper">
                        ...
                        <div class="social-links">
                            <ul class="social-media-list">
                                <li>
                                    <a rel="me" href="https://github.com/miladvh"
                                        title="miladvh">
                                        <svg class="svg-icon grey"><use href="/assets/minima-social-icons.svg#github"></use></svg></a> </li></ul>
                        </div>
                    </div>
                </footer>
            </body>
